...
namespace IntrinsicsCompat.X86toArm;
...
public class AvxCompat
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Vector128<Single> _cmp_nge_uq_ps__cmp_nge_us_ps(Vector128<Single> a, Vector128<Single> b)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Vector128<Single> _cmp_ngt_uq_ps__cmp_ngt_us_ps(Vector128<Single> a, Vector128<Single> b)
    {
    ...
    public static Vector256<Single> Compare(Vector256<Single> a, Vector256<Single> b, FloatComparisonMode imm8)
    {
        ...
        switch (imm8)
        {
            ...
            case FloatComparisonMode.UnorderedNotGreaterThanOrEqualNonSignaling:
                resultLow = _cmp_nge_uq_ps__cmp_nge_us_ps(aLow, bLow);
                resultHigh = _cmp_nge_uq_ps__cmp_nge_us_ps(aHigh, bHigh);
                break;
            case FloatComparisonMode.UnorderedNotGreaterThanSignaling:
            case FloatComparisonMode.UnorderedNotGreaterThanNonSignaling:
                resultLow = _cmp_ngt_uq_ps__cmp_ngt_us_ps(aLow, bLow);
                resultHigh = _cmp_ngt_uq_ps__cmp_ngt_us_ps(aHigh, bHigh);
                break;
